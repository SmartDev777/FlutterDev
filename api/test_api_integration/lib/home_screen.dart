...
import 'package:test_api_integration/detail_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  getUsers() async {
    ...
    var data = jsonDecode(response.body); //for without model
    print(data);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      builder: (context, AsyncSnapshot snapshot) {
        ...
        return getListFromModel(context, snapshot.data);
      },
    ));
  }

  getListFromModel(ctx, data) {
